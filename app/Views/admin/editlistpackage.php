...
<div class="container mt-4">
    ...
    <form action="<?= base_url('/crudlistpackageupdate/' . $package['id']); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="description" class="form-control" value="<?= esc($package['description']); ?>" required>
        </div>
        ...
        <div class="form-group">
            <label>Island Price Weekday Per Pax</label>
            <input type="number" name="price_per_pax" class="form-control" value="<?= esc($package['price_per_pax']); ?>" required>
        </div>

        <div class="form-group">
            <label>Island Price Weekend Per Pax</label>
            <input type="number" name="price_per_pax_weekend" class="form-control" value="<?= esc($package['price_per_pax_weekend']); ?>" required>
        </div>
